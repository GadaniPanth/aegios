...
export class ProductDataService {
  private products = [
    ...
    // BOPET Films
    {
      ...
      sec4Icon: ['assets/images/products/bopet-films/feature1.png', 'assets/images/products/bopet-films/feature2.png', 'assets/images/products/bopet-films/feature3.png', 'assets/images/products/bopet-films/feature4.png', 'assets/images/products/bopet-films/feature5.png'],
      sec4Text: ['Excellent tensile strength for industrial applications like hot stamping, yarn production and food & non-food grade application.', 'Maintains MD shrinkage below 1% at 150°C, 30 min', 'In-line coating system for enhanced ink anchorage and metal adhesion', 'High barrier and high bond metallized films available', 'Customizable optical density ranging from 0.25 to 4.0'],
      sec5Image: ['assets/images/products/bopet-films/bopet-apln-1.jpg', 'assets/images/products/bopet-films/bopet-apln-2.jpg', 'assets/images/products/bopet-films/bopet-apln-3.jpg', 'assets/images/products/bopet-films/bopet-apln-4.jpg', 'assets/images/products/bopet-films/bopet-apln-5.jpg'],
    ...
    // Metalized Films
    {
      ...
      sec4Icon: ['assets/images/products/metalized-films/feature1.png', 'assets/images/products/metalized-films/feature2.png', 'assets/images/products/metalized-films/feature3.png', 'assets/images/products/metalized-films/feature4.png'],
      sec4Text: ['Superior tensile strength for hot stamping and yarn applications.', 'Low MD shrinkage (< 1%) at 150°C, ensuring dimensional stability.', 'High barrier and strong bonding performance for secure packaging.', 'Wide range of optical density options from 0.25 to 4.0.'],
      sec5Image: ['assets/images/products/metalized-films/metaliz-apln-1.jpg', 'assets/images/products/metalized-films/metaliz-apln-2.jpg', 'assets/images/products/metalized-films/metaliz-apln-3.jpg', 'assets/images/products/metalized-films/metaliz-apln-4.jpg', 'assets/images/products/metalized-films/metaliz-apln-5.jpg', 'assets/images/products/metalized-films/metaliz-apln-6.jpg'],
      sec5Text: ['Non-heat sealable', 'High bond (crack resistance)', 'Film gradNormal barrier', 'Normal packaging', 'Low OD for ESD packaging', 'Aseptic packaging'],
      table: [
        {
          ...
          rows: [
            {
              ...
              thickness: '8, 10, 12, 15, 23, 30, 36',
              application: 'Diverse applications in both packaging and industrial sectors, offering versatile solutions for various product needs.'
            },
            {
              category: 'Low OD for ESD packaging',
              thickness: '8, 10, 12, 15, 23, 30, 36',
              application: 'Ideal for Electronic Static Discharge (ESD) and other electronic applications, providing effective protection for sensitive components.'
            },
            {
              category: 'Isotropic',
              thickness: '12, 15, 23, 30',
              application: 'High barrier properties are well-suited for lidding applications, ensuring enhanced preservation and protection of packaged products.'
            },
            {
              category: 'Twist wrap',
              thickness: '12, 15, 23, 30',
              application: 'Perfect choice for adding a decorative touch to gift wrapping and twist wrapping applications, enhancing the visual appeal of chocolates, lollipops, and other items.'
            },
            {
              category: 'High and ultra-high barrier',
              thickness: '8, 10, 12, 15, 23, 30, 36',
              application: 'Suitable for a wide range of high barrier packaging applications that require superior protection against moisture, gases, and external elements.'
            }
          ]
        },
        {
          ...
          rows: [
            {
              ...
              thickness: '12, 15, 23, 30',
              application: 'Designed for carton lamination, these films are compatible with UV-based inks and adhesive systems, enabling vibrant and durable packaging solutions.'
            },
            {
              category: 'High bond, high and ultra-high barrier',
              thickness: '12, 15, 23, 30',
              application: 'Excellent metal bond properties, well-suited for packaging and industrial applications, ensuring reliable adhesion and barrier performance.'
            },
            {
              category: 'Aseptic packaging',
              thickness: '12, 15, 23, 30',
              application: 'High barrier, high metal bond for aseptic packaging (BIB), specially for hot fills, high boiling and replacement of Al foil. Provides high barrier properties and high metal bond, making them ideal for aseptic packaging (BIB). Specifically suitable for hot fills, high boiling products, and as a replacement for aluminum foil.'
            },
            {
              category: 'Poly urethane coated film',
              thickness: '12',
              application: 'Caters to premium segments in aseptic packaging (BIB), offering superior quality and integrity for high-value products.'
            }
          ]
        },
        {
          ...
          rows: [
            {
              ...
              application: 'Perfect for lamination with paper, paperboard, and gift wrapping applications, adding a touch of elegance and enhancing visual appeal.'
            },
            {
              category: 'High bond (crack resistance)',
              thickness: '18, 20',
              application: 'Excellent for extrusion lamination, offering superior crack resistance for packaging solutions that require durability and long-lasting performance.'
            },
            {
              category: 'Normal barrier',
              thickness: '15, 18, 20, 25, 30, 35',
              application: 'Suitable for printing, lamination, and single/two-ply packaging structures, specifically designed for high-speed filling and sealing (FFS) machines, ensuring efficient and reliable production.'
            },
            {
              category: 'High barrier',
              thickness: '15, 18, 20, 25, 30, 35',
              application: 'Designed for high barrier requirements, including ice cream packaging, labels, and single/two-ply packaging structures, these films provide excellent protection and preservation of contents.'
            },
            {
              category: 'Matte metallized',
              thickness: '18, 20',
              application: 'Single/two ply packaging structure and also, provides an exceptional matte appearance, replicating the look of aluminum foil.'
            }
          ]
        }
      ],
    ...
    // Polyester (Resins & Chips)
    {
      ...
      sec4Icon: ['assets/images/products/polyester/feature1.png', 'assets/images/products/polyester/feature2.png', 'assets/images/products/polyester/feature3.png', 'assets/images/products/polyester/feature4.png'],
    ...
    // BOPP Films
    {
      ...
      sec4Icon: ['assets/images/products/bopp-film/feature1.png', 'assets/images/products/bopp-film/feature2.png', 'assets/images/products/bopp-film/feature3.png'],
      ...
      sec5Image: ['assets/images/products/bopp-film/bopp-apln-1.jpg', 'assets/images/products/bopp-film/bopp-apln-2.jpg', 'assets/images/products/bopp-film/bopp-apln-3.jpg', 'assets/images/products/bopp-film/bopp-apln-4.jpg', 'assets/images/products/bopp-film/bopp-apln-5.jpg', 'assets/images/products/bopp-film/bopp-apln-6.jpg'],
